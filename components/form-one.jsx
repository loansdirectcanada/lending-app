        ...
        <div className="bg-white border border-[#d4d6d5] rounded-[8px]">
          <div className="flex px-[24px] py-[16px] border-b border-[#f2f2f2]">
            ...
            <div className="wrap_con">
              <span className="text-[10px] font-semibold text-[#7D8380] uppercase block font-lato mb-0">Section one</span>
              <span className="text-[14px] text-[#2A2C2B] font-semibold block font-lato">Loan needs</span>
            </div>
          </div>
          <div className="max-w-[410px] mx-auto py-[40px]">
            ...
            <div className="relative mb_Bottom">
              ...
              <div className={`relative rounded-[4px] h-[50px] mr-[10px] border-animation ${show==="time_duration_in_number" && 'is-focus'}`} >
                <input
                  type="number"
                  id="text"
                  ...
                  onBlur={(e) => setShow("")}
                />
                <label className="label-text absolute left-[10px] top-[50%] -translate-y-[50%] text-[10px] text-[#a8acaa] transition-all pointer-events-none">Type a number</label>
              </div>
                <button
                    type="button"
              ...
              <div className="mt-2 container_level">
                <label className="radiobtn flex flex-col-reverse text-center items-center mr-10">
                  <input
                    ...
                    onChange={handleChanges}
                  />
                  <span className="font-lato text-[14px] font-normal capitalize text-[#2A2C2B] mb-[8px]">ASAP</span>
                  <img className="uncheckimage" src="https://application.lend.com.au/img/global/icons/Pastel/ASAP/ASAP.svg" alt="asap" />
                  <img className="checkimage" src="https://application.lend.com.au/img/global/icons/Pastel/ASAP/ASAP_active.svg" alt="asap" />
                </label>
                <label className="radiobtn flex flex-col-reverse text-center items-center">
                  <input
                    ...
                    onChange={handleChanges}
                  />
                  <span  className="font-lato text-[14px] font-normal capitalize text-[#2A2C2B] mb-[8px]">Not in rush</span>
                  <img className="uncheckimage" src="https://application.lend.com.au/img/global/icons/Pastel/Relax/Relax.svg" alt="asap" />
                  <img className="checkimage" src="https://application.lend.com.au/img/global/icons/Pastel/Relax/Relax_active.svg" alt="asap" />
                </label>
              </div>
            </div>
            <div className="relative mb_Bottom">
